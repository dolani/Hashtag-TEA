...
export default function Nav() {
  ...
  const hashtag = ["PWA", "WebDevelopment", "Javascript","React","API", "Tea"];
    return (
        <header className="App-header">
          ...
          <span className="icons">
            ...
            <i>
              <TwitterShareButton title="Here's a cool PWA I found made by @lo_victoria2666!" url={shareUrl} hashtags={hashtag}>
